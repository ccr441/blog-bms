<template>
  <div class="main-wrap" v-loading="loading">
    ...
    <el-button
      ...
      size="medium"
      icon="el-icon-search"
      @click.prevent="getArticleTypeList"
    >
      搜索
    </el-button>
    <el-button
    ...
    <el-table :data="tableData" border style="width: 100%;margin-top: 20px;">
      ...
      <el-table-column prop="sort_name" label="栏目名称"></el-table-column>
      <el-table-column
        prop="parent_name"
        label="父级栏目名称"
      ></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="{ row }">
          <el-button @click="editContentType(row)" type="text" size="small">
            编辑
          </el-button>
...
import { getArticleTypeList, deleteArticleType } from "@/api/content";
@Component
export default class User extends Vue {
  ...
  getArticleTypeList() {
    getArticleTypeList(this.search)
      .then(({ data }: any) => {
        console.log(data);
